...
@property (nonatomic, strong) myBabyViewController *feature1VC;
...
- (void)setContainerViewController {
    myBabyViewController *vc1 = [myBabyViewController new];
...
- (void)setupNavigationStyle {
    NavigationTheme *theme = [[NavigationTheme alloc]
                              ...
                              //bar color
                              barColor:[UIColor colorWithRed:0.0f/255.0f
                                                       green:111.0f/255.0f
                                                        blue:152.0f/255.0f
                                                       alpha:1.0f]
                              //title font, size
    ...
    for (UIViewController *vc in self.mContainerVCArr) {
        if (i == button.tag) {
            ...
            switch (button.tag) {
                case 0:
                {
                    UIStoryboard *storyboard=[UIStoryboard storyboardWithName:@"myBaby" bundle:[NSBundle mainBundle]];
                    myBabyViewController *controllerD = [storyboard instantiateViewControllerWithIdentifier:@"baby"];
